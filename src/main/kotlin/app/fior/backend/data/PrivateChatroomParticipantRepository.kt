...
interface PrivateChatroomParticipantRepository : ReactiveMongoRepository<PrivateChatroomParticipant, String> {
    ...
    fun getPrivateChatroomParticipantsByRoomId(roomId: String): Flux<PrivateChatroomParticipant>

    fun findByRoomIdAndParticipant1(roomId: String, participant1: String): Mono<PrivateChatroomParticipant>
